  ...
  <div class="navbar navbar-default navbar-fixed-top navbar-size-large navbar-size-xlarge paper-shadow" data-z="0" data-animated role="navigation">
	...
	c4.857-0.796,10.591,1.859,10.591,1.859l0.757-3.843L89.645,42.239z" />
      ...
      <div class="collapse navbar-collapse" id="main-nav">
        ...
        <ul class="nav navbar-nav navbar-nav-margin-left">
          ...
          <li class="dropdown active">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="active"><a href="website-student-profile.html">Private Profile</a></li>
            </ul>
          </li>
          <li class="dropdown">
        ...
        @if (Auth::guest())
            <a href="{{ url('login').'?redirectURL='.urlencode(Request::url()) }}" class="navbar-btn btn btn-primary">Log In</a>
        @else
            ...
            <li class="dropdown user active">
              ...
              <ul class="dropdown-menu" role="menu">
                ...
                <li class="{{ isset($active['profile']) ? $active['profile'] : '' }}"><a href="{{ url('profile/profile') }}"><i class="fa fa-user"></i> 个人资料</a></li>
